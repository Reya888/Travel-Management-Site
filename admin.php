...
<body>
	...
	<div class="container">
		...
		<div class="menu-list">
			<a id="a1" href="#" onclick="myFunction(document.getElementById(this.id))">Customers</a><br><br>
			<a id="a2" href="#" onclick="myFunction(document.getElementById(this.id))">Travel Agents</a><br><br>
			<a id="a3" href="#" onclick="myFunction(document.getElementById(this.id))">Places</a><br><br>
			<a id="a4" href="#" onclick="myFunction(document.getElementById(this.id))">Hotels</a><br><br>
